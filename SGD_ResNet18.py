...
with open("sgd_resnet18.txt", "w") as f:
...
with open('sgd_resnet18.pkl', 'wb') as f:
    pickle.dump(history, f)
       
with open('sgd_resnet18.pkl', 'rb') as f:
...
with open("sgd_resnet18.txt", "a") as f:
