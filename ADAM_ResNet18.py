...
with open("adam_resnet18.txt", "w") as f:
...
with open('adam_resnet18.pkl', 'wb') as f:
    pickle.dump(history, f)
       
with open('adam_resnet18.pkl', 'rb') as f:
...
with open("adam_resnet18.txt", "a") as f:
...
model.save('ADAM_ResNet18.keras')
