...
noise_multiplier = 8.1  # Adjust this for different privacy levels
...
with open("dpadam_resnet50_1.txt", "w") as f:
...
with open('dpadam_resnet50_1.pkl', 'wb') as f:
    pickle.dump(history, f)
       
with open('dpadam_resnet50_1.pkl', 'rb') as f:
...
with open("dpadam_resnet50_1.txt", "a") as f:
...
model.save('DPADAM_ResNet50_1.keras')
