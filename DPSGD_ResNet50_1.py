...
noise_multiplier = 8.1  # Amount of noise
...
with open("dpsgd_resnet50_1.txt", "w") as f:
...
with open('dpsgd_resnet50_1.pkl', 'wb') as f:
    pickle.dump(history, f)
       
with open('dpsgd_resnet50_1.pkl', 'rb') as f:
...
with open("dpsgd_resnet50_1.txt", "a") as f:
...
model.save('DPSGD_ResNet50_1.keras')
